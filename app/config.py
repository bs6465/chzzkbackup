...
CLIP_MIN_FREE_BYTES = int(os.getenv("CLIP_MIN_FREE_BYTES", str(DISK_WARN_BYTES)))
LOG_RETENTION_DAYS = int(os.getenv("LOG_RETENTION_DAYS", "30"))
LOG_RETENTION_MAX_ROWS = int(os.getenv("LOG_RETENTION_MAX_ROWS", "1000"))
FAILED_TEMP_RETENTION_DAYS = 7
TRASH_RETENTION_DAYS = 7
TRASH_DIR_NAME = ".chzzkbackup-trash"
CLIP_RESULT_RETENTION_HOURS = 24
CLIP_JOB_HISTORY_DAYS = 7
CLIP_TEMP_DIR = TEMP_DIR / "clips"
